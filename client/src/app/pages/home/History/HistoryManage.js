...
const headRows = [
  ...
  { id: 'FromName', numeric: 'center', visibility:true,disablePadding: false, label: 'Name(Send)' },
  { id: 'ToName', numeric: 'center', visibility:true,disablePadding: false, label: 'Name(Receive)' },
  { id: 'Amount', numeric: 'center', visibility:true,disablePadding: false, label: 'Amount' },
  { id: 'Percentage amount', numeric: 'center', visibility:true,disablePadding: false, label: 'Percentage Amount' },
...
function HistoryManage(props) {
  ...
  // console.log('history_allinfoaass',allinfo);

  // console.log('history_allinfo',allinfo);
            ...
            <TableBody>
              {stableSort(allinfo, getSorting(order, orderBy))
                ...
                .map((row, index) => {
                  ...
                  console.log('row',row.adminPercentageAmount);
                  return (
                    <TableRow
                      hover
                      role="checkbox"
                    ...
                    >
                      ...
                      <TableCell align="center">{(row.adminPercentageAmount!=undefined) ? row.adminPercentageAmount.amount/100+ ' $' :0}</TableCell>
                      <TableCell align="center">{row.createdDate}</TableCell>
                      <TableCell align="center">
                      <Button variant="contained" color={(row.charge.status === 'pending')?'secondary':'default'}>{row.charge.status}</Button>
                      </TableCell>
                      {/* {row.adminPercentageAmount.amount/100 + ' $'} */}
                      {/* <TableCell align="center">
