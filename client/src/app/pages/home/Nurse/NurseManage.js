      ...
      <div className={classes.actions}>
        {numSelected > 0 ? (
          ...
          <Tooltip title="Add Nurse">
            ...
            <Link to="/admin/nurse/create_edit">
              <IconButton
...
function NurseManagement(props) {
  console.log("NURSEMANAGEMENT", props);
  ...
  // const allClientsNames = props.clients.forEach((name) => {
  //   name.firstName;
  // });

  // console.log("allCLientNames", props.clients);

  // const allClientsName = props.clients.map((client) => client.firstName);

  // const output = [allClientsName].map((name) => ({ name }));
  // console.log("output", output);

  // const getClientName = props.clients.find(
  //   (element) => element.firstName == element.firstName
  // );
  // console.log("getClientName", getClientName);

  const clientNames = props.clients.map((n) => n.firstName);
  const uniqueNames = [...new Set(clientNames)];
  // console.log("uniqueNames", uniqueNames);
  // const cNames = uniqueNames.forEach((names) => {
  //   return names;
  // });
  // console.log("---cNames---", cNames);

  // const options = [
  //   { value: uniqueNames[0], label: uniqueNames[0] },
  ...
  function updatePermission(arr) {
    actions.ginveNursesPermission(arr);
    // .then(res => {
    // disableLoading();
    // let {data} = res;
    // if(!data.success) {
                    ...
                    >
                      ...
                      <TableCell align="center">
                        ...
                        >
                          <option
                            value="1"
                            selected={row.permission == 1 ? "selected" : ""}
                          >
                            Yes
                          </option>
                          <option
                            value="0"
                            selected={row.permission == 0 ? "selected" : ""}
                          >
                            No
                          </option>
                        </select>
