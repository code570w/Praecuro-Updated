...
function CertificationAccount(props) {
  ...
  const handleSave=(result)=>{
    ...
    setTimeout(() => {
      ...
      actions.updateCertification(result).then(res=>{
        disableLoading();
        let {data} = res;
        if(!data.success){
          setStatus(data.errMessage);
    ...
    <div className="row" style={{backgroundColor: "white", padding: "40px 20px 40px 20px"}}>
      ...
      <div className="col-md-8">
        <div className="col-md-12">
          <span className="col-md-6 cold-sm-12" style={{fontSize: "1.275rem", fontWeight: 600 }}>Certification Information</span>
          <div className="col-md-6 col-sm-12 pull-right">
            <Link to="/admin/certification"><button className="btn btn-secondary pull-right">Cancel</button></Link>
        ...
        <div className="col-md-12" style={{marginTop: 60}}>
          ...
          <div className="form-group row">
            <label className="col-xl-3 col-lg-3 col-form-label">Certificatoin Name</label>
            <div className="col-lg-9 col-xl-6">
          ...
          <div className="form-group row">
            ...
            <div className="col-lg-9 col-xl-6">
              <input className="form-control" type="date" value={ndate} onChange={ (e) => setDate(e.target.value) }/>
            </div>
          </div>
          <div className="form-group row">
            <label className="col-xl-3 col-lg-3 col-form-label">Expiry Date</label>
            <div className="col-lg-9 col-xl-6">
              <input className="form-control" type="date" value={edate} onChange={ (e) => seteDate(e.target.value) }/>
            </div>
          </div>
        </div>
      </div>
