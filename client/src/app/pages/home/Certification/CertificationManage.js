...
import Popup_modal_certificate from "../Popup_modal_certificate";
      ...
      actions
        ...
        .then((res) => {
          ...
          if (!data.success) {
            ...
            actions.getAllCertification().then((res) => {
...
EnhancedTableToolbar.propTypes = {
  ...
  allCertifications: PropTypes.func,
...
function CertificationManagement(props) {
  ...
  // console.log('admin_allCertifications',props.certifications)
    ...
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <EnhancedTableToolbar
          ...
          selected={selected}
          allCertifications={props.allCertifications}
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="center">
                        {row.active === "Active" ? "Valid" : "In-valid"}
                      </TableCell>
                      <TableCell align="center">
                        <Modal
                          key={row._id}
                          isOpen={modalIsOpen.bool}
                          onRequestClose=""
                          style={customStyles}
                          contentLabel=""
                        ...
                        {/* <Popup_modal_certificate 
                            keyField={modalIsOpen.key}
                            isOpen={modalIsOpen.bool}
                      ...
                      <TableCell align="right">
                        <Link
                          to="/admin/certification/create_edit"
